            ...
            <div class="row gy-5">
               <div class="col-lg-3 col-md-6 col-sm-6">
                  <div class="footer-about">
                     <img src="assets/images/law network logo.png" alt="image">
                     <p>the discipline and profession concerned with the customs, practices, and rules 
                         Enforcement of the body of rules is through a controlling authority.</p>
               ...
               <div class="col-lg-3 col-md-6 col-sm-6 d-flex justify-content-lg-center justify-content-sm-end justify-content-md-end">
                  <div class="footer-item">
                     <h4>Category</h4>
                     <ul class="link-list">
                        <li><a href="services.php">Civil Law</a></li>
                        <li><a href="services.php">Family Law</a></li>
                        <li><a href="services.php">Workplace Accident</a></li>
                        <li><a href="services.php">Criminal Law</a></li>
                        <li><a href="services.php">Cyber Law</a></li>
                        <li><a href="services.php">Real State Law</a></li>
                     </ul>
                  </div>
               </div>
                  ...
                  <div class="footer-item">
                     ...
                     <ul class="contact-list">
                        <li>
                           ...
                           <div class="text">
                              <a href="tel:+8801761111456">+92340454886</a>
                              <a href="tel:+8801761111458" class="mb-0">+92340454886</a>
                           </div>
                        </li>
                        <li>
                           <div class="icon">
                        ...
                        <li>
                           ...
                           <div class="text">
                              SD-1, Block A North Nazimabad Town, Karachi City, Pakistan
                           </div>
                        </li>
                     </ul>
                  </div>
                  ...
                  <div class="footer-item">
                     ...
                     <ul class="recent-caselist">
                        <li>
                           ...
                           <div class="text">
                              <span></span>
                              <h5><a href="study1.php">Family Law</a></h5>
                           </div>
                        </li>
                        <li>
                           <div class="image">
                           ...
                           <div class="text">
                              <span></span>
                              <h5><a href="study2.php">Criminal Law</a></h5>
                           </div>
                        </li>
                     </ul>
                  </div>
      ...
      <div class="container">
         <div class="footer-bottom">
            <div class="row d-flex align-items-center g-3">
               <div
                  class="col-lg-6 d-flex justify-content-lg-start justify-content-center text-lg-start text-center px-1">
                  <p>Copyright 2022 <a href="#" class="egns-lab">Law Network </a> | Design By <a
                        href="https://aptech-education.com.pk/" class="egns-lab">Aptech STD
                        </a></p>
               </div>
